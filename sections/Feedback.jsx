  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold text-26px sm:text-[32px] leading-[32px] sm:leading-[40px] text-white">Samantha</h4>
      ...
      >
        <img src="/planet-09.png" alt="planet-09" className="w-full lg:h-[610px] min-h-[210px] h-auto object-cover rounded-[40px]" />
        <motion.div
